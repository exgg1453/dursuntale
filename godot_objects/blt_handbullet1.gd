# Auto-converted from GameMaker: blt_handbullet1
...
func _ready():
	...
	path_start(2/* path_hand1 */, 0.2, 0, 0/* path_action_stop */)
	dmg= 0
	rot= 0
	$Alarm0.start((8) / 30.0)
	inactive= 0
...
func _on_destroy():
	if(inactive == 0) {
	    if(x1 == 0) iii= instance_create(x + 22, y + 5, 611/* blt_chasefire1 */)
