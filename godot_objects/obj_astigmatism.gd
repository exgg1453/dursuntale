# Auto-converted from GameMaker: obj_astigmatism
...
func _gm_event_2_6():
	...
	GS.msg[0]= "...&..."
	if(mycommand < 75) GS.msg[0]= "You\'ve&seen&enough."
	if(mycommand < 50) GS.msg[0]= "Take&your&last&look."
	if(mycommand < 25) GS.msg[0]= "..."
	if(whatiheard == 1) {
	    if(mercymod < 0) GS.msg[0]= "What are&you so&afraid&of?"
	    if(mercymod > 80) GS.msg[0]= "Finally,&someone&gets it."
	}
	if(whatiheard == 3) {
	    if(mercymod < 0) GS.msg[0]= "How&dare&you."
	    if(mercymod > 80) GS.msg[0]= "That\'s&right!"
	}
	if(whatiheard == 4) {
	    if(mercymod < 1) GS.msg[0]= "You&dare&defy me?"
	    if(mercymod > 80) GS.msg[0]= "You\'ve&pushed&your&luck."
	}
	if(impress == 1) GS.msg[0]= "That&takes&guts."
	impress= 0
	if(turnt == 0) {
	    if(pickon == 0) GS.msg[0]= "...&Don\'t&pick on&me."
	    if(pickon == 1) GS.msg[0]= "...&Pick on&me."
	    turnt= 1
	}
	GS.msg[1]= "%%%"
	GS.typer= 2
...
func _process(delta: float):
	...
	if(GS.mnfight == 2) {
	    if(attacked == 0) {
	        ...
	        if(mycommand >= 50) {
	            gen= instance_create(x, y, 390/* obj_astigmatismgen */)
	            gen.dmg= GS.monsteratk[myself]
	        } else  {
	            gen= instance_create(x, y, 391/* obj_stromboligen */)
	            gen.dmg= GS.monsteratk[myself]
	            if(pop == 1) gen.rate++
	        }
	        if(mycommand >= 0)
	            GS.msg[0]= "* Astigmatism gazes through&  your soul."
	        if(mycommand >= 30)
	            GS.msg[0]= "* Astigmatism gives you a&  hypnotizing glare."
	        if(mycommand >= 70)
	            GS.msg[0]= "* Astigmatism clicks its teeth."
	        if(mycommand >= 90) GS.msg[0]= "* Smells like glasses."
	        if(mercymod < -100)
	            GS.msg[0]= "* Astigmatism has gone&  bloodshot."
	        if(mercymod > 100)
	            GS.msg[0]= "* Astigmatism doesn\'t care&  about fighting anymore."
	        if(GS.monsterhp[myself] < GS.monstermaxhp[myself] / 3)
	            GS.msg[0]= "* Astigmatism is watering."
	        attacked= 1
	    }
	    if(mercymod == 999999) {
	        GS.turntimer= -1
	...
	if(GS.myfight == 2 and whatiheard != -1 and GS.heard == 0) {
	    if(whatiheard == 0) {
	        GS.msc= 0
	        GS.msg[0]= "* ASTIGMATISM - ATK 32 DEF 26&* This relentless bully ALWAYS&  gets its way./^"
	        OBJ_WRITER.halt= 3
	    ...
	    if(whatiheard == 3) {
	        GS.msc= 0
	        GS.msg[0]= "* You pick on Astigmatism./^"
	        OBJ_WRITER.halt= 3
	    ...
	    if(whatiheard == 1) {
	        GS.msc= 0
	        GS.msg[0]= "* You don\'t pick on Astigmatism./^"
	        if(pickon == 1) mercymod= -120
	        if(pickon == 0) mercymod= 120
	        OBJ_WRITER.halt= 3
	        iii= instance_create(GS.idealborder[0], GS.idealborder[2], 782/* OBJ_WRITER */)
	    ...
	    if(whatiheard == 4) {
	        ...
	        sum= scr_monstersum()
	        if(sum == 1) GS.msg[0]= "* You stand up to Astigmatism./^"
	        if(sum > 1)
	            GS.msg[0]= "* You stand up to Astigmatism^1.&* The other monsters are&  impressed./^"
