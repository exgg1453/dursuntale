# Auto-converted from GameMaker: obj_paptrash
...
func _on_destroy():
	...
	GS.facechoice= 0
	GS.faceemotion= 0
	GS.msg[0]= "* (You visited the trash&  can.)/%%"
	if(instance_exists(1025/* obj_papyrusparent */)) {
	    scr_papface(0, 0)
	    GS.msg[1]= "THAT\'S THE TRASH&CAN./"
	    GS.msg[2]= "FEEL FREE TO VISIT&IT ANY TIME./%%"
	}
...
func _process(delta: float):
	...
	if(obj_kitchenchecker.level > 0) z_index= 100005
